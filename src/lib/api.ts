...
const baseUrl = process.env.NEXT_PUBLIC_PRODUCTION_URL || process.env.NEXT_PUBLIC_DEVELOPMENT_URL
...
export async function updateBlogPost(id: string, formData: FormData): Promise<Response> {

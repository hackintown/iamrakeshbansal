...
export default function ThirdSlide() {
  return (
    <section className="w-full flex items-center bg-gradient-to-br from-gray-900 to-black py-16">
            ...
            <div className="mt-12 flex flex-wrap gap-8">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-gray-400">Traders mentored</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-gray-400">Book downloads</p>
                </div>
              </div>
              <div className="flex items-center">
          ...
          >
            ...
            <div className="relative bg-gray-800 rounded-2xl p-8 shadow-2xl">
              <Image
                ...
                width={500}
                height={300}
                className="w-full rounded-lg shadow-lg mb-6 h-[500px] object-contain"
              />
              ...
              <Button className="w-full px-6 py-3 text-base font-medium text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:from-purple-600 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900">

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-8 sm:mt-12 relative">
              <div className="absolute inset-y-0 left-0 top-4 flex pl-3 pointer-events-none">
                <Search className="w-5 h-5 text-gray-400" />
              </div>
              <input
                type="text"
                placeholder="Search for trading strategies, e.g., 'Fibonacci Retracement'"
                className="block w-full py-3 pl-10 pr-3 text-white placeholder-gray-400 bg-white 
              ...
              />
              <Button className="mt-4 w-full sm:w-auto px-6 py-3 text-base font-medium text-white bg-gradient-to-r from-green-500 to-blue-500 rounded-lg hover:from-green-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                Explore Strategies
              </Button>
            </div>

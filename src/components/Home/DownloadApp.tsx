...
export default function DownloadApp() {
  return (
    <section className="relative overflow-hidden pt-10 lg:pb-24">
        ...
        <div className="py-10 sm:py-16 lg:py-24 2xl:pl-24">
          <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
            ...
            <div className="relative px-12">
              <div className="absolute inset-x-0 bottom-20 left-1/2 -translate-x-1/2 -mb-48 lg:-mb-72 text-green-400 w-[460px] h-[460px] sm:w-[600px] sm:h-[600px]">
                <svg
              ...
              <Image
                ...
                width={320}
                height={640}
                className="relative w-full max-w-xs mx-auto -mb-36"
              />
            </div>
          </div>
        </div>

      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow-2xl rounded-lg overflow-hidden">
          <div className="px-4 py-5 sm:p-6 lg:p-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-8 text-center">
              HNI Service
            </h1>
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 rounded-md shadow-inner">
          ...
          <div className="px-4 py-6 bg-gray-50 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-center items-center">
              <Link
                ...
                rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2
                focus:ring-primary transition duration-150 ease-in-out transform hover:scale-105"
              >
                Register Now
              </Link>
            </div>
